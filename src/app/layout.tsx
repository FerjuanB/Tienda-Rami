      ...
      <body className={`${roboto.variable} ${roboto.className} bg-secondary-light`}>
        <header className="bg-gradient-to-r from-primary-dark to-primary-light text-white py-4 shadow-lg">
          <div className="container mx-auto px-4 flex justify-between items-center">
            <img src="/logo.png" alt="Logo" className="w-16 h-16 sm:w-24 sm:h-24 rounded-lg" />
            
            <p className="text-xl sm:text-3xl font-semibold text-gray-200 uppercase">Tienda de regalos</p>
          </div>
        </header>
        {children}
